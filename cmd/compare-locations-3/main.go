...
func main() {
	...
	flag.StringVar(&vector_database_uri, "vector-database-uri", "sqlite://?model=mxbai-embed-large&dsn=%7Btmp%7D%7Bgeohash%7D.db%3Fcache%3Dshared%26mode%3Dmemory&embedder-uri=ollama%3A%2F%2F%3Fmodel%3Dmxbai-embed-large&max-distance=4&max-results=10&dimensions=1024&compression=none&max-conns=1", "...")

	flag.StringVar(&source_location_database_uri, "source-location-database-uri", "sql://sqlite3?dsn=/usr/local/data/overture/alltheplaces-locations.db", "...")
