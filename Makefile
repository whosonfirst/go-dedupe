...
cli:
	go build -mod $(GOMOD) -ldflags="$(LDFLAGS)" -o bin/compare-locations cmd/compare-locations/main.go
	go build -mod $(GOMOD) -ldflags="$(LDFLAGS)" -o bin/index-locations cmd/index-locations/main.go
